...
//        clientConnection ! SendMessage(SERIALIZER.ROW,s"chat|${message.utf8String}")
        ...
        var message :ByteString = ByteString.newBuilder.putByte(0.asInstanceOf[Byte]).result() ++ ByteString("","UTF-8")
...
object StressMain extends App {
  ...
  val system = ActorSystem("StressMain", ConfigFactory.load("client"))
